    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#queryActivityBtn").click(function () {
                //查询所有符合条件数据的第一页以及所有符合条件数据的总条数，默认每页显示10条
                queryActivityByConditionForPage(1, $("#demo_page1").bs_pagination("getOption", "rowsPerPage"));
            });
           ...
           /* //给列表中所有checkbox标签添加单击事件
            $("#tBody input[type = 'checkbox']").click(function () {
                //如果列表中的所有checkbox都选中，则全选按钮也选中
                if ($("#tBody input[type = 'checkbox']").size() == $("#tBody input[type = 'checkbox']:checked").size()){
                    $("#checkAll").prop("checked", true);
                }else { //如果列表中的所有checkbox至少有一个没选中，则全选按钮也取消选中
            ...
            $("#deleteActivityBtn").click(function () {
                ...
                if( window.confirm("确定删除吗？")) {
                    var ids = "";
                    $.each(checkedIds, function (index, obj) {//id=xxx&....id=xxxx&
                        ids += "id=" + this.value + "&";
                    });
                    ids = ids.substr(0, ids.length - 1); //id=xxx&....id=xxxx
                    //发送请求
                    $.ajax({
            ...
            $("#editActivityBtn").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        //把市场活动的信息回显在修改的模态窗口上
                        $("#edit-id").val(data.id); //修改的市场活动的id
                        //浏览器会依option标签内容比对data.owner与名字的对应关系，选上实际名字
            ...
            $("#exportActivityXzBtn").click(function () {
                ...
                $.each(checkedIds, function (index, obj) {
                    ids += "id=" + obj.value + "&"; //ids="id=xxx&id=xxx&..id=xxx&"
                });
                ids = ids.substr(0, ids.length - 1); //id=xxx&id=xxx&..id=xxx
                //发送同步请求
                //workbench/activity/exportActivitiesByIds.do?id=xxx&id=xxx&..id=xxx
            ...
            $("#importActivityBtn").click(function () {
                ...
                //截取文件名后缀，若为xls、XLS、xLs、Xls、xlS等等，统一转为xls
                ...
                $.ajax({
                    ...
                    data: formData,
                    processData: false, //设置ajax向后台提交参数之前，是否把参数统一转成字符串，默认是true--->是
                    contentType: false, //设置ajax向后台提交参数之前，是否把所有的参数统一按urlencoded编码，默认是true--->是
                    type: "post",
                    dataType: "json",
                    success: function (data) {
                        if (data.code == "1") {
            ...
            $("#download").click(function () {
                //发送同步请求
                window.location.href = "workbench/activity/downloadModel.do";
            });
        });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data.activityList, function (index, obj) {
                        ...
                        htmlStr += "</tr>";
                    }); //最终的htmlStr是一堆<tr>标签，每个<tr>标签是一行市场活动的显示
                    $("#tBody").html(htmlStr);
                    ...
                    $("#demo_page1").bs_pagination({
                        ...
                        //用户每次切换页号，都自动触发本函数
                        //每次返回切换页号之后的pageNo和pageSize，且更新currentPage和rowsPerPage的值，显示新分页条
            ...
            <div class="modal-body">
                ...
                <form id="createActivityForm" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="create-startTime" name="myDate" readonly>
                        </div>
                        <label for="create-endTime" class="col-sm-2 control-label">结束日期</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="create-endTime" name="myDate" readonly>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="edit-startTime" value="2020-10-10" name="myDate" readonly>
                        </div>
                        <label for="edit-endTime" class="col-sm-2 control-label">结束日期</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="edit-endTime" value="2020-10-20" name="myDate" readonly>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 350px;">
                ...
                <div style="position: relative;top: 40px; left: 50px;">
                    ...
                    <input type="button" id="download" value="下载模板">
                </div>
